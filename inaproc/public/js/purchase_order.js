// This script is loaded for the Purchase Order doctype (from inaproc app).
// It adds custom logic for document handling and UI tweaks.

// The 'refresh' event is now additive and will not override the standard controller.
...
// The 'custom_upload_support_doc' event handler.
frappe.ui.form.on('Purchase Order', 'custom_upload_support_doc', function(frm) {
